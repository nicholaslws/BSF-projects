...
Please read the relevant RAs before using them. 
...
## Egg traps
We have implemented the use of 2 different types of egg traps: wooden traps and cardboard traps. Label cage the trap is from so that we can track the performance of the cages. 
