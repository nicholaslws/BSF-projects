...
### Fermentation!
For fermentation, we are currently using EM1 solution. We prepare it by mixing EM1, molasses and water in a 1:1:20 ratio ( ~ 5L of EM1 and molasses in a blue drum). After 1-2 weeks, the solution should turn a lighter shade of brown and it is then ready for us. You can refer to the brochures for instructions. 

During the longer holidays or for general feeding, we might need to ferment food. Each drum of fermented food should be good for about three months, the length of the summer break. So far, we have tried 10L of EM1 per bin which seems to work well. The food should be filled up roughly to the handles of the bin. Filling beyond that point might lead to food overflowing from the bin during fermentation. Due to the breakdown of the food and the extra liquids added, the  fermented food might be watery at the bottom of the bin. It is recommended to mix it well before serving.
