...
![Fig 3. BSF bait boxes with traps](images/trap.png){width=50%}
...
![Fig 5. Example of a wooden trap](images/wooden trap.jpg){width=50%}
...
![Fig 6. Example of a cardboard trap](images/cardboard trap.jpg){width=50%}
